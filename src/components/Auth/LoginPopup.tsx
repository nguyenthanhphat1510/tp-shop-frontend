...
const LoginPopup = () => {
    const { login, setShowLoginModal, switchToRegister, loginWithGoogle } = useAuth();
            ...
            <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl relative">
                ...
                <div className="p-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-3 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors ${errors.email ? 'border-red-500' : 'border-gray-300'
                                        }`}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full pl-10 pr-3 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 transition-colors ${errors.password ? 'border-red-500' : 'border-gray-300'
                                        }`}
                    ...
                    <div className="space-y-3">
                        <button
                            onClick={loginWithGoogle} // FIX: Thêm onClick handler
                            type="button"
